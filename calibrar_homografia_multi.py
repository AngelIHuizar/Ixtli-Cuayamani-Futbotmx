...
# Puntos de referencia (nombre, coordenada real en cm). En caso de que alguien quiera usar esto para probar con otras vistas, por favor hacer click EN ESTE ORDEN:
REFERENCIAS = [
...
cv2.imwrite("outputs/verificacion_homografia_multi.jpg", warp)
print("Guardado: outputs/verificacion_homografia_multi.jpg")